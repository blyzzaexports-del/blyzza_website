    ...
    <footer className="bg-foreground text-primary-foreground py-16">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-medium text-primary-foreground mb-4">
              Quick Links
            </h4>
            <ul className="space-y-3">
              {["Home", "Shop", "Products", "About", "Contact"].map((link) => (
                <li key={link}>
                  <Link
        ...
        <div className="pt-8 border-t border-primary-foreground/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <Link
              href="#"
              className="text-primary-foreground/50 hover:text-primary-foreground/70 transition-colors duration-200 text-sm"
            >
              Privacy Policy
            </Link>
            <Link
